...
<%--            style="max-width: 100%"--%>
<%--            >Contact</a--%>
<%--          ><a href="./sign-in.jsp" class="navbar-light-navbutton w-button">Sign In</a>--%>
<%--        </nav>--%>
<%--        <div--%>
...
<nav>
    ...
    <ul class="nav__links">
        <li class="link"><a href="./auth/login.jsp">Login</a></li>
        <li class="link"><a href="./auth/registration.jsp">Registration</a></li>
    </ul>
</nav>
</body>
</html>
